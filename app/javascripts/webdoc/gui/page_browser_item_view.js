...
WebDoc.PageBrowserItemView = $.klass({
  ...
  editUrl: function( str ) {
    ddd('[PageBrowserItemView] editUrl');
    var self = this,
        node,
        popOptions;
    ...
    if ( typeof str === 'undefined' ) {
      ...
      if ( WebDoc.application.pageBrowserController.visible ) {
        ...
        // TODO: We lack a way of knowing what was clicked.
        node = jQuery(".toolbar-panel a[href='#add-web-page']");
      ...
      this._popForm.pop(
        jQuery.extend( popOptions, {
          attachTo: node,
          initCallback: function(){
            var currentTitle = "http://"//self.page.getTitle();
            ...
            self._popForm.bind('submit', function(e){
              ddd('submot');
              ddd(self._popTitle.val());              
              self.page.setExternalPageUrl( self._popTitle.val() );
              self._popForm.trigger('close');
