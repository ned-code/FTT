function JMBProfile(){
    ...
    module.message = {
        ...
        FTT_MOD_PROFILE_EDITOR_EDIT_BASIC_DETAILS:"Basic Details",
			...
			select:{
				...
				gender:function(name, selected){
					...
					sb._('<select name="')._(name)._('">');
						sb._('<option ')._(value[0])._('>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_GENDER_FEMALE)._('</option>');
						sb._('<option ')._(value[1])._('>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_GENDER_MALE)._('</option>');
					sb._('</select>');
					return sb.result();
				},
				living:function(name, is_alive){
					...
					sb.clear();
					sb._('<select name="')._(name)._('">');
						sb._('<option ')._(value[0])._('>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_LIVING_YES)._('</option>');
						sb._('<option ')._(value[1])._('>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_LIVING_NO)._('</option>');
					sb._('</select>');
					return sb.result();
				},
				...
				months:function(name, selected){
					...
					sb._('<select name="')._(name)._('">');
						for(i=1 ; i <= months.length ; i++ ){
                            var monthName = message['FTT_MOD_PROFILE_EDITOR_FORM_'+(months[i-1].toUpperCase())];
		...
		return {
			basic:function(){
				...
				sb._('<table id="basic_fields">');
					sb._('<tr>');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_GENDER)._(':</span></div></td>');
						sb._('<td>')._(gen.select.gender('gender', user.gender))._('</td>');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_LIVING)._(':</span></div></td>');
						sb._('<td>')._(gen.select.living('living', user.is_alive))._('</td>');
					sb._('</tr>');
					sb._('<tr>');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_FIRST_NAME)._(':</span></div></td>');
						sb._('<td colspan="3"><input name="first_name" type="text" value="')._(user.first_name)._('"></td>');
					sb._('</tr>');
					sb._('<tr>');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_MIDDLE_NAME)._(':</span></div></td>');
						sb._('<td colspan="3"><input name="middle_name" type="text" value="')._(user.middle_name)._('"></td>');
					sb._('</tr>');
					sb._('<tr>');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_LAST_NAME)._(':</span></div></td>');
						sb._('<td colspan="3"><input name="last_name" type="text" value="')._(user.last_name)._('"></td>');
					sb._('</tr>');
					sb._('<tr>');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_KNOW_AS)._(':</span></div></td>');
			...
			eventdate:function(){
				...
				sb._('<table id="date_fields">');
					sb._('<tr id="birthdate">');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_BORN)._('</span></div></td>');
						sb._('<td>');
					...
					sb._('<tr id="birthplace">');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_BORNPLACE)._('</span></div></td>');
						sb._('<td>');
					...
					sb._('<tr id="deathdate" style="')._((user.is_alive)?'display:none':'')._('">');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_DEATH)._('</span></div></td>');
						sb._('<td>');
					...
					sb._('<tr id="deathplace" style="')._((user.is_alive)?'display:none':'')._('">');
						sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_DEATHPLACE)._('</span></div></td>');
						sb._('<td>');
				...
				sb._('<div id="jmb-union-')._(count)._('" class="jmb-dialog-profile-content-union" family_id="')._(family.id)._('" spouse_id="')._(family.spouse)._('">');
					sb._('<form id="jmb-profile-addpsc-')._(count)._('" method="post" family_id="')._(family.id)._('" target="iframe-profile">');
						sb._('<div class="jmb-dialog-profile-content-unions-header">');
							...
							if(cp) sb._('<div id="current_partner"><input name="current_partner" type="radio"> ')._(message.FTT_MOD_PROFILE_EDITOR_FORM_SHOW_CURRENT_PARTNER)._('</div>');
							sb._('<div id="button"><input type="submit" value="')._(message.FTT_MOD_PROFILE_EDITOR_SAVE)._('"></div>');
						sb._('</div>');
								...
								sb._('<tr>');
									sb._('<td valign="top"><div class="jmb-dialog-profile-content-unions-part">');
										sb._('<table id="union_event">');
											sb._('<tr>');
												sb._('<td><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_TYPE)._(':</span></td>');
												sb._('<td><select name="marr_type"><option value="MARR">')._(message.FTT_MOD_PROFILE_EDITOR_FORM_TYPE_MARRIAGE)._('</option></select></td>');
											sb._('</tr>');
											sb._('<tr id="marrdate">');
												sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_DATE)._('</span></div></td>');
												sb._('<td>');
											...
											sb._('<tr id="marrplace">');
												sb._('<td><div><span>')._(message.FTT_MOD_PROFILE_EDITOR_FORM_LOCATION)._('</span></div></td>');
												sb._('<td>');
												...
												sb._('</td>');
											sb._('</tr>');
											sb._('<tr><td></td><td><input name="deceased" ')._(user.is_divorce_event(family.id)?'checked':'')._(' type="checkbox" style="position:relative; top:3px;">&nbsp;')._(message.FTT_MOD_PROFILE_EDITOR_FORM_DIVORCE)._('&nbsp;<input placeholder="Year" name="marr_divorce_year" type="text" style="width:40px;" value="')._(user.divorce(family.id, 'date', 2))._('" maxlength="4"></td></tr>');
										sb._('</table>');
									sb._('</div></td>');
								sb._('</tr>');
							sb._('</table>');
