...
(function(jQuery) {
	...
	jQuery.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'components/com_manager/modules/member_profile/imgs/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'components/com_manager/modules/member_profile/imgs/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'components/com_manager/modules/member_profile/imgs/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'components/com_manager/modules/member_profile/imgs/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:			'components/com_manager/modules/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
