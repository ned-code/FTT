		...
		return this.each(function() {
		    ...
		    if(tipContent && settings.clickIt){
				...
				obj.click(function(el){
					var top, left;
					var divObject = jQuery("<div class='"+ settings.toolTipClass +"'><p class='aToolTipContent'>"+ tipContent +"</p></div>");
					obj.attr({title: ''});
					if(settings.comparisonObj){
						top =  $(settings.comparisonObj).offset().top + settings.yOffset;
						left = $(settings.comparisonObj).offset().left + settings.xOffset;
					} else {				
						top = obj.offset().top - $('.' + settings.toolTipClass).outerHeight() - settings.yOffset
						left = obj.offset().left + obj.outerWidth() + settings.xOffset
					}
					...
					$('.' + settings.closeTipBtn).click(function(){
						...
						settings.eventClose.call(obj);
						return false;
					});
					settings.eventClick.call(obj, divObject);
					return false;			
			    });
		    }
