 ...
 *
 * @package PhpGedView
 * @version $Id: functions_name.php 6617 2009-12-24 17:03:01Z fisharebest $
 */
require_once 'functions_rtl.php';
...
function DMSoundex($name) {
	...
	if (!defined('PGV_DMSOUNDS_UTF8_PHP')) {
		...
		require '../components/com_manager/php/gedcom/Parser/includes/dmsounds_UTF8.php';
	}
