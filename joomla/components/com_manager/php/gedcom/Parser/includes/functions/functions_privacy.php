...
*
* @version $Id: functions_privacy.php 6509 2009-12-01 18:42:59Z wooc $
* @package PhpGedView
* @subpackage Privacy
*/
...
*/
function privatize_gedcom($gedrec,&$pgv_lang, &$factarray, &$GEDCOM, &$SHOW_PRIVATE_RELATIONSHIPS, &$pgv_private_records, &$TBLPREFIX,&$global_facts, &$person_facts) {
	//global $pgv_lang, $factarray, $GEDCOM, $SHOW_PRIVATE_RELATIONSHIPS, $pgv_private_records, $TBLPREFIX;
	//global $global_facts, $person_facts;
