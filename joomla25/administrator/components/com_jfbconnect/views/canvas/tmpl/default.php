...
<div>
    ...
    <a href="https://www.facebook.com/dialog/pagetab?app_id=<?php echo $this->jfbcLibrary->facebookAppId;?>
    &display=popup&next=<?php echo $websiteUrl;?>" target="_BLANK">Click Here.</a>
    <?php } else
    { ?>
