...
<div>
    ...
    <div class="config_row">
        <div class="config_setting">User Creation:</div>
        <div class="config_option">
            <fieldset id="create_new_users" class="radio">
                ...
                <label for="create_new_users1">Full Joomla User</label>
                ...
                <label for="create_new_users0">Facebook User Only</label>
            </fieldset>
        </div>
        <div class="config_description hasTip"
             title="Full Joomla User::A new Joomla user will be created whenever a user logs in using Facebook
            credentials. This allows a user to return to the site using their Joomla credentials while not logged into
            Facebook.<br/><br/>
            <b>Facebook User Only</b><br/>A pseudo-Joomla user is created when a user logs in using Facebook. They will not
    ...
    <div class="config_row">
        ...
        <div class="config_description hasTip"
            ...
            <b>No</b><br/>The 'User Creation' setting above will apply. The user will be asked to associate their Facebook
    ...
    <div class="config_row fullJoomla">
        <div class="config_setting">Email Field on Registration<br/>(Full Joomla User Only):</div>
        <div class="config_option">
    ...
    <div class="config_row facebookOnly">
        <div class="config_setting">Auto Username Prefix<br/>(Facebook User Only):</div>
        <div class="config_option">
        ...
        <div class="config_description hasTip"
             title="Prefix for username when 'Facebook User Only' is enabled. Username examples: fb_12345, alex.andreae12345 or
            aleand12345">Info
        </div>
        <div style="clear:both"></div>
    </div>
        ...
        <div class="config_option">
            <fieldset id="facebook_auto_login" class="radio facebookAutoLogin">
                <input type="radio" id="facebook_auto_login1" name="facebook_auto_login"
                       ...
                       onclick="jfbcAdmin.config.setRelatedOptions('facebookLogout', '0', 'JFBConnect has detected that your \'Autologin Facebook Users\' and \'Logout of Joomla Only\' settings are both enabled. If both these settings are Yes, the user will not be able to log out of your site.\n\nWe are automatically setting \'Logout of Joomla Only\' to No.')"/>
        ...
        <div class="config_option">
            <fieldset id="logout_joomla_only" class="radio facebookLogout">
                <input type="radio" id="logout_joomla_only1" name="logout_joomla_only"
                       ...
                       onclick="jfbcAdmin.config.setRelatedOptions('facebookAutoLogin', '0', 'JFBConnect has detected that your \'Autologin Facebook Users\' and \'Logout of Joomla Only\' settings are both enabled. If both these settings are Yes, the user will not be able to log out of your site.\n\nWe are automatically setting \'Auto Login Facebook Users\' to No.')"/>
...
<div>
    <div>
        <div class="config_row">
            ...
            <div class="config_description header">Description</div>
            <div style="clear:both"></div>
            <div>JFBConnect automatically determines the permissions required for the user to login based on your settings.<br/>Use the option below to specify additional permissions you want if you are developing custom functionality which needs additional user permissions.</div>
        </div>
