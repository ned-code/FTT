...
?>
    <div>
        ...
        <div class="config_row">
            ...
            <div class="config_description hasTip"
                title="When enabled, the first 100 characters in your article text will be used for the og:description property.">Info
            </div>
            <div style="clear:both"></div>
        </div>
        <div class="config_row">
            ...
            <div class="config_option" style="width:375px">
                <textarea rows="15" cols="45" name="social_graph_fields"><?php echo $model->getSetting('social_graph_fields') ?></textarea>
            </div>
            <div class="config_description hasTip"
                title="Open Graph fields will be added to your page in the following order:
                <ol>
                    <li>All {JFBCGraph} tags will be added first. Use these tags to specify values for individual pages.</li>
                    ...
                    <li>
                        The default fields specified to the left will be added to all of your site pages. They will not override any {JFBCGraph} tags.
...
?>
    <div>
        <div class="config_row">
            <div class="config_setting header">Social Module/Plugin Setting</div>
            <div class="config_option header">Options</div>
            <div class="config_description header">Description</div>
            <div style="clear:both"></div>
        </div>
...
?>
    ...
    Example: {JFBCComments href=http://www.sourcecoast.com width=550 num_posts=10 colorscheme=dark}<br/>
    <br/>
    <table class="options">
        <tr>
            <th>Parameter</th>
    ...
    <h3>Fan:</h3>
    Example: {JFBCFan}<br/>
    Example: {JFBCFan height=200 width=200 colorscheme=light href=http://www.sourcecoast.com show_faces=true stream=false header=true border_color=blue}<br/>
    <br/>
    <table class="options">
        <tr>
            <th>Parameter</th>
    ...
    <h3>Like:</h3>
    Example: {JFBCLike}<br/>
    Example: {JFBCLike url=http://www.sourcecoast.com layout=standard show_faces=true show_send_button=true width=300 action=like font=verdana colorscheme=light}<br/>
    <br/>
    <table class="options">
        <tr>
            <th>Parameter</th>
    ...
    <h3>Send:</h3>
    Example: {JFBCSend}<br/>
    Example: {JFBCSend url=http://www.sourcecoast.com font=verdana colorscheme=light ref=homepage}<br/>
    <br/>
    <table class="options">
        <tr>
            <th>Parameter</th>
    ...
    Example: {JFBCGraph url=http://www.sourcecoast.com}<br/>
    Example: {JFBCGraph image=http://www.sourcecoast.com/images/stories/extensions/jfbconnect/home_jfbconn.jpg}<br/>
    Example: {JFBCGraph description=Facebook connect integration for Joomla! Let users register and log into your site with their Facebook credentials.}
    ...
    Example: {SCTwitterShare url=http://www.sourcecoast.com data_count=horizontal}<br/>
    <br/>
    <table class="options">
        <tr>
            <th>Parameter</th>
    ...
    Example: {SCGooglePlusOne url=http://www.sourcecoast.com annotation=inline size=standard}<br/>
    <br/>
    <table class="options">
        <tr>
            <th>Parameter</th>
    ...
    Example: {JLinkedShare url=http://www.sourcecoast.com/jlinked/ counter=top}<br/>
    <br/>
    <table class="options">
        <tr>
            <th>Parameter</th>
