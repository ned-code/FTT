...
<div id="editcell">
	...
	for ($i = 0, $n = count($items); $i < $n; $i++)
	{
		...
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td><a href="<?php echo JRoute::_('index.php?option=com_jfbconnect&controller=notification&task=display&fbuserfrom='.$row->fb_user_id);?>"><?php echo $row->sent?></a></td>
            <td><a href="<?php echo JRoute::_('index.php?option=com_jfbconnect&controller=notification&task=display&fbuserto='.$row->fb_user_id);?>"><?php echo $row->received?></a></td>
