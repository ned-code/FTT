...
class LocaliseControllerPackage extends JControllerForm
{
  ...
  public function download() 
  {
    ...
    else
    {
      ...
      setcookie(JUtility::getHash($this->_context . '.author'), $package->author, time()+60*60*24*30);
      setcookie(JUtility::getHash($this->_context . '.copyright'), $package->copyright, time()+60*60*24*30);
      setcookie(JUtility::getHash($this->_context . '.email'), $package->email, time()+60*60*24*30);
      setcookie(JUtility::getHash($this->_context . '.url'), $package->url, time()+60*60*24*30);
      setcookie(JUtility::getHash($this->_context . '.version'), $package->version, time()+60*60*24*30);
      setcookie(JUtility::getHash($this->_context . '.license'), $package->license, time()+60*60*24*30);
