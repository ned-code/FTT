...
?>
<?php echo JHtml::_('sliders.start', 'com_localise_legend_translations', array('allowAllClose'=>true, 'startOffset'=>-1, 'useCookie'=>true));?><?php echo JHtml::_('sliders.panel', JText::_('COM_LOCALISE_SLIDER_TRANSLATIONS_LEGEND'), 'legend');?>
