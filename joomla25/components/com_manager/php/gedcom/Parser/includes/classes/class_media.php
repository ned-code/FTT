 ...
 * @package PhpGedView
 * @subpackage Charts
 * @version $Id: class_media.php 6481 2009-11-28 20:17:25Z fisharebest $
 */
...
class gMedia extends GedcomRecord {
	var $title         =null;
	var $file          =null;
	var $ext           ='';
	var $mime          ='';
	...
	// Create a gMedia object from either raw GEDCOM data or a database row
	function gMedia($data) {
		if (is_array($data)) {
	...
	// Get an instance of a gMedia object  We either specify
	...
	/**
	 * check if the given gMedia object is in the objectlist
	 * @param gMedia $obje
