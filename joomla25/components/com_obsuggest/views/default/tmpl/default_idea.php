<?php
/**
 * @version		$Id: default_idea.php 152 2011-03-12 06:19:57Z thongta $
	...
	<tr>
		<td valign="top" width="15%">			
			<table>
				<tr>
					<td>
						<div class="score">Score <?php echo $this->idea->votes; ?></div>
					</td>
				</tr>
				<tr>
					<td>
		...
		<td>
			<table>
				<tr>
					<th>
						<div id="title<?php echo $this->idea->id; ?>" class="title_idea"><?php echo $this->idea->title; ?></div>
						<i>
				...
				<tr>
					...
					<td id="rps<?php echo $this->idea->id; ?>">
						<div onclick="addRepose('rps<?php echo $this->idea->id; ?>')" onmousemove="onmove('rps<?php echo $this->idea->id; ?>')" onmouseout="onout('rps<?php echo $this->idea->id; ?>')"><i><?php echo JText::_("Add Response")?></i></div>
					</td>
					<?php } else { ?>
					<td>
					...
					<td>
						<span style="float: left;">
							<div style="float:left" id="cm<?php echo $this->idea->id; ?>" onClick="" onmousemove="onmove('cm<?php echo $this->idea->id; ?>')" onmouseout="onout('cm<?php echo $this->idea->id; ?>')">
								<a href="index.php?controller=comment&task=display&idea_id=<?php echo $this->idea->id?>"><font color="#076ACD"><?php echo JText::_("Comment")?></font></a> |
							</div>							
							<div style="float:left"><?php echo JText::_("by")?> <font color="#076ACD">CuongPQ</font> |</div>
