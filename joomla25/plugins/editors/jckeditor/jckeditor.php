	...
	function onDisplay( $name, $content, $width, $height, $col, $row, $buttons = true )
	{
		...
		if( !$loaded )
		{
		  /* Generate the Output */
			...
			return  $errors . JCKHtmlwriterHelper::EditorTextArea($name,$content,$buttons,$this,$arributes);

		}//end if		
			
		return JCKHtmlwriter::TextArea( $name, $content, $arributes ).'<script>window.addDomReadyEvent.add( function(){ 
