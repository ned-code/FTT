...
class JPaneTabs extends JPane
{
	...
	public function startPane($id){
		...
		$this->ul_list .= '<ul class="nav nav-tabs">';
		return '<div class="tab-content" style="position: absolute; top: 200px; width:80%">';
	}
	...
	public function startPanel($text, $id){
		...
		$this->ul_list .= '<li class="'.$active_class.'"><a data-toggle="tab" href="#'.$id.'">'.$text.'</a></li>';
		return '<div id="'.$id.'" class="tab-pane '.$active_class.'">';
	}
