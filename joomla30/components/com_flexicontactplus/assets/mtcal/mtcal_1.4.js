...
// Mootools 1.4 compatibility by Chris G
...
var Calendar = new Class({  
  ...
  Implements: Options,
    ...
    toggle: function(cal) {
        document.removeEvents('mousedown');  // always remove the current mousedown script first
        ...
        if (matches) {
            ...
            arr.each(function(c, i) {
                ...
                switch(c) {
                    // year cases
                    case 'y':
                        i = '20' + i; // 2 digit year assumes 21st century
                    case 'Y':
                        dates[0] = i.toInt();
                        break;
