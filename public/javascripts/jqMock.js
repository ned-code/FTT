...
(function ($) {
	...
	function Mock(obj, fnName) {
		...
		var _verify = function(verifyUnmatched, defaultMsg) {
		...
		this.verify = function(defaultMsg) {
			_verify(false, defaultMsg);
		};
		this.verifyAll = function(defaultMsg) {
			_verify(true, defaultMsg);
		};		
	};	
	//===================
