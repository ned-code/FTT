Factory.define :ub_sync_transaction_item do |ub_sync_transaction_item|
  ...
  ub_sync_transaction_item.part_hash_control      {|a| Digest::MD5.file(fixture_file(a.path)).hexdigest }
  ub_sync_transaction_item.item_hash_control      {|a| Digest::MD5.file(fixture_file(a.path)).hexdigest }
